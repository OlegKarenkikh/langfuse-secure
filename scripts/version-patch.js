...
const patches = [
  ...
  // ── tar / glob ─────────────────────────────────────────
  ['tar',  v => v && v.startsWith('4.'), '4.4.19'],
  ['tar',  v => v && v.startsWith('6.'), '6.2.1'],
  ['tar',  null, '7.5.13'],
  ['glob', v => v && v.startsWith('7.'), '7.2.3'],
  ['glob', v => v && v.startsWith('8.'), '8.1.0'],
  ['glob', v => v && v.startsWith('9.'), '9.3.5'],
  ['glob', v => v && v.startsWith('10.'), '10.4.5'],
  ['glob', v => v && v.startsWith('11.'), '11.1.0'],
  ['glob', v => v && v.startsWith('13.'), '13.0.6'],
  ['glob', null, '13.0.6'],

  // ── misc (single-target) ───────────────────────────────
  ['dompurify',            null, '3.4.2'],
  ['ajv',                  v => v && v.startsWith('6.'), '6.12.6'],
  ['ajv',                  null, '8.20.0'],
  ['webpack',              null, '5.106.2'],
  ['vite',                 null, '8.0.10'],
  ['diff',                 null, '9.0.0'],
  ['tmp',                  null, '0.2.4'],
  ['axios',                v => v && v.startsWith('0.'), '0.31.1'],
  ['axios',                null, '1.16.0'],
  ['rollup',               null, '4.60.2'],
  ['qs',                   null, '6.15.1'],
  ['cross-spawn',          null, '7.0.6'],
  ['basic-ftp',            null, '6.0.1'],
  ['@tootallnate/once',    null, '3.0.1'],
  ['@hono/node-server',    null, '2.0.1'],
  ['langsmith',            null, '0.6.0'],
  ['micromatch',           v => v && v.startsWith('3.'), '3.1.10'],
  ['micromatch',           null, '4.0.8'],
  ['braces',               v => v && v.startsWith('2.'), '2.3.2'],
  ['braces',               null, '3.0.3'],
  ['ejs',                  v => v && v.startsWith('3.'), '3.1.10'],
  ['ejs',                  null, '5.0.2'],
  ['follow-redirects',     null, '1.16.0'],
  ['negotiator',           null, '1.0.0'],
  ['ipaddr.js',            null, '2.3.0'],
  ['json5',                null, '2.2.3'],
  ['cookie-signature',     null, '1.2.2'],
  ['set-value',            null, '4.1.0'],
  ['mixin-deep',           null, '2.0.1'],
  ['got',                  null, '15.0.3'],
  ...
  ['undici', v => v && v.startsWith('8.') && semverLt(v,'8.2.0'), '8.2.0'],
  ...
  // ── async ──────────────────────────────────────────────
  ['async', v => v && v.startsWith('2.'), '2.6.4'],
  ...
  ['fast-xml-parser',      v => v && v.startsWith('3.'), '3.21.1'],
  ['fast-xml-parser',      v => v && v.startsWith('4.'), '4.5.6'],
  ['fast-xml-parser',      null, '5.7.2'],
  ['serialize-javascript', null, '7.0.5'],
  ['flatted',              null, '3.4.2'],
  ['kysely',               null, '0.28.8'],
  ['nodemailer',           null, '8.0.7'],
  ...
  ['send', v => v && v.startsWith('1.'), '1.2.1'],
  ['send', null, '1.2.1'],
  ['serve-static', v => v && v.startsWith('1.'), '1.16.2'],
  ['serve-static', v => v && v.startsWith('2.'), '2.2.1'],
  ['serve-static', null, '2.2.1'],
  ['tough-cookie', v => v && v.startsWith('4.'), '4.1.4'],
  ['tough-cookie', v => v && v.startsWith('5.'), '5.1.0'],
  ['tough-cookie', null, '6.0.1'],
  ['postcss', v => v && v.startsWith('7.'), '7.0.39'],
  ['postcss', null, '8.5.13'],
