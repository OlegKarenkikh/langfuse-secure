...
const patches = [
  ...
  // ── next: CVE-2026-27977..27980, CVE-2026-29057 ──
  ['next', v => v && semverLt(v,'16.1.7'), '16.1.7'],
  // ── lodash / lodash-es: CVE-2026-2950, CVE-2026-4800 ──
  ['lodash',    null, '4.18.0'],
  ...
  // ── flatted: CVE-2026-33228 (CVSS 9.8 CRITICAL) ──
  ['flatted', null, '3.4.2'],
  // ── kysely: CSPW-0062 protestware + CVE-2026-32763 + GHSA-8cpq ──
  // Physical replacement handled by patch-all.js (fetcher stage uses github:olegkarenkikh/kysely)
  ['kysely', null, '0.28.14'],
  ...
  // ── picomatch: CVE-2026-33671, CVE-2026-33672 ──
  ['picomatch', v => v && v.startsWith('2.'), '2.3.2'],
  ['picomatch', v => v && v.startsWith('4.'), '4.0.4'],
  ['picomatch', null, '4.0.4'],
  // ── path-to-regexp: CVE-2026-4867 (v0), CVE-2026-4923/4926 (v8) ──
